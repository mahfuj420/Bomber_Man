...
def check_intr():
    try:
        requests.get("https://github.com/mahfuj420")
    except Exception:
        bann_text()
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.GeneralMessage("Starting Bombing")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("Bomber was created by N.A.M Mahfuj")
...
description = """ BomberMan Diya Manuser Hoga mairo
...
Bomber_Man is not intented for malicious uses.
"""
