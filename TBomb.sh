...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Welcome To N.A.M Mahfuj'
    else
        figlet TheGamer
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bombing Was Created By \e[1;32m N.A.M MAHFUJ\e[0m"
    else
...
do
    banner
    echo -e "\e[4;31m Manusher Hoga Marar Dhanda Koiro Na?? !!! \e[0m"
    echo " "
    echo "Press 1 To   SMS  Bombing "
